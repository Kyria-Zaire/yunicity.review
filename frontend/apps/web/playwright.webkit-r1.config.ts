  ...
  projects: [
    {
      ...
      testMatch:
        /functional\/(13-mobile-safari-closure|17-feed-composer-photo-mobile|18-feed-composer-photo-portrait|19-mobile-feed-full-bleed|20-modal-overlay-bottom-nav|21-mobile-feed-functional|22-medium-feed-shell-rail)\.spec\.ts$/,
      use: {
        ...devices["iPhone 14"],
        browserName: "webkit",
