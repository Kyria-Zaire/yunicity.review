...
type TribesAppShellProps = {
  children: ReactNode;
};

/** Shell Tribus — mobile MOBILE-TRIBES-01 + desktop portail existant. */
export function TribesAppShell({ children }: TribesAppShellProps) {
  return (
    <div className="web-shell-page tribes-mobile-shell min-h-dvh bg-[#F4F5F7]">
      <WebMobileHeader />
