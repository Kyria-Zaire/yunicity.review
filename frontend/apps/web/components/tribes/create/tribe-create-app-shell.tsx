...
/** Shell création tribu — mobile sans navbar / medium / desktop (MOBILE-TRIBE-CREATE-01). */
export function TribeCreateAppShell({ children }: { children: ReactNode }) {
  return (
    <div className="web-shell-page tribe-create-mobile-shell tribes-mobile-shell min-h-dvh bg-[#F4F5F7]">
      <WebMobileHeader />
      ...
      <div className="web-three-col places-shell-grid">
        ...
        <main className="web-main-column min-w-0 pt-0 sm:pt-2 xl:pt-0">
          <div className="web-tribes-chrome-only web-desktop-tribe-create-only">
            <CitizenTopNav />
          </div>
