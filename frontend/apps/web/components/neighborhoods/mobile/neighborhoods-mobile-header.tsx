...
import { NEIGHBORHOODS_PAGE_TITLE } from "@yunicity/utils";
import { Bell } from "lucide-react";
import Link from "next/link";

/** Header mobile Quartiers — logo · titre · cloche (MOBILE-QUARTIERS-01). */
export function NeighborhoodsMobileHeader() {
