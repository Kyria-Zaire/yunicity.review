...
type NeighborhoodDetailMediumPracticalProps = {
  detail: NeighborhoodDetail;
};

export function NeighborhoodDetailMediumPractical({ detail }: NeighborhoodDetailMediumPracticalProps) {
  ...
  return (
    <section
      id="nd-medium-practical"
      className="neighborhood-detail-section rounded-2xl border border-neutral-200/90 bg-white p-4 shadow-sm sm:p-5"
    >
