...
export function OrganizationRequestDesktopDuplicateCheck() {
  return (
    <section
      className="rounded-2xl border border-[#C7D2FE] bg-[#EEF0FF] p-4"
      data-org-request-desktop-duplicate=""
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm leading-relaxed text-neutral-600">{ORG_REQUEST_DUPLICATE_BODY}</p>
