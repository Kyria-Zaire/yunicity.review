...
/**
 * Header de contenu Sortir medium — 640 → 1023,98 px (aligné FeedMediumHeader).
 */
export function SortirMediumHeader({
  city,
  filterPanelOpen,
  filterActive,
  onOpenFilter,
  ...
  return (
    <div className="sortir-medium-header" data-sortir-medium-header="">
      <span
        data-sortir-medium-header-identity=""
      ...
      <span
        data-sortir-medium-header-city=""
      ...
      <button
        type="button"
        data-sortir-medium-header-search=""
      ...
      <button
        type="button"
        ref={filterButtonRef}
        data-sortir-medium-header-filter=""
        data-sortir-medium-filter-active={filterActive ? "" : undefined}
