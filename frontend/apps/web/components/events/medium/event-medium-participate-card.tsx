...
type EventMediumParticipateCardProps = {
  event: LocalEvent;
  toggling: boolean;
...
/** Carte Participer horizontale — rail medium (maquette). */
export function EventMediumParticipateCard({
  event,
  toggling,
  isAuthenticated,
  onToggleInterest,
}: EventMediumParticipateCardProps) {
  ...
  return (
    <section
      ...
      data-event-medium-participate=""
    >
      <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_minmax(12.5rem,15rem)] sm:items-center">
