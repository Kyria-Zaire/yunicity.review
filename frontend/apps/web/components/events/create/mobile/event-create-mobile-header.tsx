...
import { EVENT_CREATE_MOBILE_BACK } from "@yunicity/utils";
import { ArrowLeft } from "lucide-react";
import { useRouter } from "next/navigation";

export function EventCreateMobileHeader() {
  const router = useRouter();

  return (
    <header
      className="sticky top-0 z-[var(--z-chrome)] border-b border-neutral-200/80 bg-white pt-[env(safe-area-inset-top)]"
      data-event-create-mobile-header=""
    >
      <div className="flex items-center gap-2 px-3 py-2.5">
        <button
          ...
          aria-label={EVENT_CREATE_MOBILE_BACK}
        >
