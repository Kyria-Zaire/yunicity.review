...
import { ProfileEditMobileView } from "@/components/profile/mobile";
...
export function ProfileEditScreen() {
  ...
  const desktopContent = (
    <div className="web-desktop-profile-edit-only mx-auto w-full max-w-[1400px] px-3 py-2 sm:px-4 lg:px-6">
