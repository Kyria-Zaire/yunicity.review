...
type SettingsDetailSectionsProps = {
  user: AuthUser | null;
  profile: ProfileMe;
...
function PrefToggle({
  ...
  return (
    <label className="flex cursor-pointer items-start justify-between gap-3 rounded-xl border border-neutral-100 px-4 py-3 hover:bg-neutral-50">
...
export function SettingsDetailSections({
  user,
  profile,
  preferences,
  pushDevices,
  ...
  async function handlePersonalSave(event: FormEvent) {
  ...
  return (
    <div className="mt-10 space-y-6 border-t border-neutral-200/80 pt-10">
      <SectionCard sectionId={settingsSectionDomId("personal")} title={SETTINGS_PERSONAL_TITLE}>
        <form onSubmit={(event) => void handlePersonalSave(event)} className="space-y-4">
          {profileError ? (
      ...
      <SectionCard sectionId={settingsSectionDomId("verification")} title={SETTINGS_VERIFICATION_TITLE}>
        <div className="flex items-start gap-3 rounded-xl bg-neutral-50 px-4 py-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <p className="text-xs text-neutral-500">{verification.onboardingLabel}</p>
          </div>
        </div>
      </SectionCard>
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-neutral-500">
                    Vu {formatSettingsDateTime(device.last_seen_at)}
                  </p>
                </div>
                <button
                  type="button"
