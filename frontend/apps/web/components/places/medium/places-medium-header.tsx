...
type PlacesMediumHeaderProps = {
  city: string;
  filterPanelOpen: boolean;
  filterActive: boolean;
  onOpenFilter: (trigger: HTMLButtonElement) => void;
  onFocusPlacesSearch?: () => void;
  filterButtonRef?: Ref<HTMLButtonElement>;
};

/**
 * Hero header Lieux medium — 640 → 1023 px (aligné SortirMediumHeader / FeedMediumHeader).
 */
export function PlacesMediumHeader({
  city,
  filterPanelOpen,
  filterActive,
  onOpenFilter,
  ...
  return (
    <div className="places-medium-header" data-places-medium-header="">
      <span
        data-places-medium-header-identity=""
      ...
      <span
        data-places-medium-header-city=""
      ...
      <button
        type="button"
        data-places-medium-header-search=""
      ...
      <button
        type="button"
        ref={filterButtonRef}
        data-places-medium-header-filter=""
        data-places-medium-filter-active={filterActive ? "" : undefined}
