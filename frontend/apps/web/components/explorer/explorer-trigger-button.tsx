...
import { ExplorerSearchPill } from "@/components/explorer/explorer-search-pill";
...
export function ExplorerTriggerButton({ variant, className = "" }: ExplorerTriggerButtonProps) {
  ...
  return (
    <ExplorerSearchPill
      ...
      className={className}
      trailing={
        <kbd className="ml-1 hidden rounded border border-neutral-200 bg-neutral-50 px-1.5 py-0.5 text-[10px] font-medium text-neutral-500 2xl:inline">
