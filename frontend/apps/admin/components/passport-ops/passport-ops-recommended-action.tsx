import type { PassportOpsNextAction } from "@yunicity/utils";
import { ArrowRight, Compass } from "lucide-react";
import Link from "next/link";

export function PassportOpsRecommendedAction({ action }: { action: PassportOpsNextAction }) {
  return (
    <section
      ...
      aria-labelledby="passport-ops-next-action-title"
    >
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <h2
            id="passport-ops-next-action-title"
