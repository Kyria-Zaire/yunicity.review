...
interface OfferDetailAuditSectionProps {
...
function actorLabel(item: AdminPartnerOfferActionItem): string {
...
export function OfferDetailAuditSection({
  items,
  total,
  page,
  pageSize,
                  ...
                  {items.map((item) => (
                    <tr key={item.id} className="hover:bg-stone-50/80">
                      <td className="px-4 py-3 font-medium text-stone-900">
                        {offerAdminActionLabel(item.action)}
                      </td>
                      ...
                      <td className="px-4 py-3 text-xs text-stone-500">
                        {formatOfferDate(item.created_at)}
                      </td>
                    </tr>
                  ))}
                </tbody>
