import type { PartnerOffersCatalogNextAction } from "@yunicity/utils";
import { GraduationCap } from "lucide-react";
import Link from "next/link";

type PassportOffersConseilProps = {
  message: string;
  action: PartnerOffersCatalogNextAction;
};

export function PassportOffersConseil({ message, action }: PassportOffersConseilProps) {
  return (
    <section
      ...
      aria-labelledby="passport-offers-conseil-title"
    >
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          <h2 id="passport-offers-conseil-title" className="text-sm font-bold text-stone-950">
            Conseil
          </h2>
