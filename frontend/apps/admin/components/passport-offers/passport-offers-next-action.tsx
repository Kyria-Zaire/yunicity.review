...
export function PassportOffersNextAction({ action }: { action: PartnerOffersCatalogNextAction }) {
  return (
    <section
      ...
      aria-labelledby="passport-offers-next-action-title"
    >
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <h2
            id="passport-offers-next-action-title"
