import type { CreatorContentEditorialNextAction } from "@yunicity/utils";
import { GraduationCap } from "lucide-react";
import Link from "next/link";

type CreatorContentConseilProps = {
  message: string;
  action: CreatorContentEditorialNextAction;
};

export function CreatorContentConseil({ message, action }: CreatorContentConseilProps) {
  return (
    <section
      ...
      aria-labelledby="creator-content-conseil-title"
    >
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          <h2 id="creator-content-conseil-title" className="text-sm font-bold text-stone-950">
            Conseil
          </h2>
