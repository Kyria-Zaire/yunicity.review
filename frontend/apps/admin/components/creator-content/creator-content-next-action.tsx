...
export function CreatorContentNextAction({
  action,
}: {
  ...
  return (
    <section
      ...
      aria-labelledby="creator-content-next-action-title"
    >
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <h2 id="creator-content-next-action-title" className="text-sm font-semibold text-stone-950">
            {action.title}
          </h2>
