...
type EventsConseilProps = {
  message: string;
  action: EventsAgendaNextAction;
};

export function EventsConseil({ message, action }: EventsConseilProps) {
  return (
    <section
      ...
      aria-labelledby="events-conseil-title"
    >
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          <h2 id="events-conseil-title" className="text-sm font-bold text-stone-950">
            Conseil
          </h2>
