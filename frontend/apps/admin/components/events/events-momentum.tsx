      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <div className="min-w-0 flex-1">
          <div
            ...
            aria-valuemin={0}
            aria-valuemax={100}
            aria-label={`Progression agenda : ${momentum.progressPercent} pourcent`}
          >
            <div
