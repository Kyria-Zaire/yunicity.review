import type { PartnerLeadRecommendedAction } from "@yunicity/utils";
import { ArrowRight, Compass } from "lucide-react";
import Link from "next/link";

export function PartnerLeadsRecommendedAction({
  action,
  onAddProspect,
}: {
  action: PartnerLeadRecommendedAction;
  onAddProspect?: () => void;
}) {
  const isAddAction = action.id === "add" && onAddProspect;
