...
type ModerationConseilProps = {
  message: string;
  action: ModerationTrustSafetyNextAction;
};

export function ModerationConseil({ message, action }: ModerationConseilProps) {
  return (
    <section
      ...
      aria-labelledby="moderation-conseil-title"
    >
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          <h2 id="moderation-conseil-title" className="text-sm font-bold text-stone-950">
            Conseil
          </h2>
